<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPasswordSuccess.aspx.cs" Inherits="EPP.CorporatePortal.Shared.ResetPasswordSuccess" %>
        ...
        <div class="row wrapper">
            ...
            <div class="login-section">
                <div class="login-section-inner-wrapper">
                    ...
                    <h3 class="page-title pw-updated">Check your email</h3>
                    <p class="center">We have sent an email containing the temporary password. <br />You will be redirected in 3 seconds..</p>
