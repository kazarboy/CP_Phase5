    ...
    public partial class ClaimNewPolicy : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                CommonEntities.ClaimProcessSteps(2, Common.Enums.ClaimStepsStatus.complete.ToString(), true, ResolveUrl("~/Application/ClaimNewClaim.aspx?&CorpId=" + newCorpId + "&Return=1"), this, userName);
        ...
        protected void Continue(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect(ResolveUrl("~/Application/ClaimNewBank.aspx?&CorpId=" + corpID));
            }
            catch (Exception ex)
            {
